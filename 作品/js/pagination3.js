...
(function(){
    ...
    let presents = ["五险一金","年终奖金","定期体检","餐饮补贴","通讯补贴","定期团建","弹性工作","节日福利","专业培训","带薪休假",
    "扁平管理","加班补贴","股票期权","绩效奖金","周末双休","高温补贴","健身瑜伽","晋升空间大","大牛带队","免费班车",]
...
(function(){
    ...
    var getsjjg = ['中专及其以下', '博士', '大专','本科',"硕士"];
var getsjjgrs = [2687,2615,45219,136541,16324];
...
(function(){
    ...
    option = {
        ...
        legend: {
            ...
            align: 'left',
            orient: 'horizonal',
            data: ['0-5K','5K-10K','10K-20K','20K-30K','30K+']
        },
        series: [
            {
                name: '区间',
                ...
                data: [
                    {value: 3996, name: '0-5K'},
                    {value: 34752, name: '5K-10K'},
                    {value: 100144, name: '10K-20K'},
                    {value: 43642, name: '20K-30K'},
                    {value: 20852, name: '30K+'}
                ]
            }
        ]
    };
...
(function(){
    ...
    option = {
        ...
        xAxis: [
          {
            type: 'category',
            data: ["字节跳动","之江实验室","海隆软件","杰士德精密工业","星宇车灯","腾讯","润和软件","海隆软件","格力电器","德科信息"],
            axisPointer: {
              type: 'shadow'
            }
        ...
        series: [
            
          {
            name: '记录数量：',
            type: 'bar',
            data: [4296,4135,1628,703,671,568,562,459,385,364],
            barWidth: 15,
            itemStyle: {
                normal:{  
          ...
          
          {
            ...
            smooth:true, 
            yAxisIndex: 1,
            data: [37.72,21.15,7.32,11.87,11.11,44.31,18.07,8.02,11.31,14.74],
            barWidth: 15,
          }
        ]
      };
...
(function(){
    ...
    var option = {
      ...
      dataset: {
        source: [
          ['城市', '上海', '深圳', '广州', '北京', '杭州', '武汉',"南京","成都","苏州","西安"],
          ['Java工程师', 2642, 1814, 1449, 1138, 997, 918 ,858 , 739, 678, 634 ],
          ['软件工程师', 1889, 2348, 504, 484, 425, 423, 476, 389, 899,375],
          ['算法工程师', 647,578,375,459,255,364,340,241,463,237],
          ['运维工程师', 435,254,152,175,546,124,334,143,125,98],
          ['测试工程师', 752,654,546,342,472,406,361,393,571,241]
        ]
      },
      xAxis: { type: 'category' },
      yAxis: { 
